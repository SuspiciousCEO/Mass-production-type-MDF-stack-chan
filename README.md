...
### ススや焦げがある
レーザー加工機で焼き切っているので、どうしてもコゲとススはご愛嬌です。
気になるようでしたら、作業前に使い古しの歯ブラシでこすったり、ウェットティッシュで拭き取ってみてください。
ダイレクトに水洗いするとMDFは木と紙の間くらいの材質なので、ふやけてモロモロになってしましますので注意。
...
輪っかの形をしているスペーサーを間にはさみながら、M3x10ネジとナットを使って締め付けます。
